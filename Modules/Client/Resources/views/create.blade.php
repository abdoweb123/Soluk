...
<form action="{{ route(activeGuard().'.clients.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <input  type="hidden"  value="{{ request('type') }}" name="type_id" id="type_id" class="form-control" required>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <input type="number" min="0" name="points" parsley-trigger="change" value="" required class="form-control">
        </div>
