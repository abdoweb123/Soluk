...
<head>
    ...
    <style>
        ...
        .btn-inverse{background-color: {{setting('main_color')}} !important; }
    </style>
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal m-t-20" action="{{route('admin.login')}}" method="POST">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input name="phone" id="phone" type="tel" class="form-control" value="{{ old('phone') }}" placeholder="@lang('trans.phone')">
                        </div>
                    </div>
